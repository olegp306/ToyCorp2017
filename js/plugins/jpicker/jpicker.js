...
$.fn.jPicker.defaults = /* jPicker defaults - you can change anything in this section (such as the clientPath to your images) without fear of breaking the program */
      ...
      images:
        {
            clientPath: 'js/plugins/jpicker/images/', /* Path to image files */
            colorMap:
          {
              width: 256,
              height: 256,
      ...
      localization: /* alter these to change the text presented by the picker (e.g. different language) */
        ...
        text:
          {
              title: localize('jpickerTitle'),
              newColor: localize('jpickerNew'),
              currentColor: localize('jpickerCurrentColor'),
              ok: localize('jpickerOk'),
              cancel: localize('jpickerCancel')
          },
        tooltips:
          {
              colors:
            {
              ...
              buttons:
            {
                ok: localize('jpickerTooltipsOk'),
                cancel: localize('jpickerTooltipsCancel')
            },
              hue:
            {
                radio: localize('jpickerTooltipsHueRadio'),
                textbox: localize('jpickerTooltipsHueTextbox')
            },
              saturation:
            {
                radio: localize('jpickerTooltipsSaturationRadio'),
                textbox: localize('jpickerTooltipsSaturationTextbox')
            },
              value:
            {
                radio: localize('jpickerTooltipsValueRadio'),
                textbox: localize('jpickerTooltipsValueTextbox')
            },
              red:
            {
                radio: localize('jpickerTooltipsRedRadio'),
                textbox: localize('jpickerTooltipsRedTextbox')
            },
              green:
            {
                radio: localize('jpickerTooltipsGreenRadio'),
                textbox: localize('jpickerTooltipsGreenTextbox')
            },
              blue:
            {
                radio: localize('jpickerTooltipsBlueRadio'),
                textbox: localize('jpickerTooltipsBlueTextbox')
            },
              alpha:
            {
                radio: localize('jpickerTooltipsAlphaRadio'),
                textbox: localize('jpickerTooltipsAlphaTextbox')
            },
              hex:
            {
                textbox: localize('jpickerTooltipsHexRadio'),
                alpha: localize('jpickerTooltipsHexAlpha')
            }
          }
    }
  };
...
$(function () {
    ...
    scriptManager.Jpicker = $.fn.jPicker;

    var objects = $('[data-plugin="jpicker"]');
    for (var i = 0, arrLength = objects.length; i < arrLength; i += 1) {
        objects.eq(i).jPicker(utilities.Eval(objects.eq(i).attr('data-jpicker-options')) || {});
    }
});
