        ...
        PIE.BackgroundStyleInfo = PIE.StyleInfoBase.newStyleInfo({
            ...
            */
            ...
            getCss3: PIE.StyleInfoBase.cacheWhenLocked(function () {
                var el = this.targetElement;
                var cs = el.currentStyle || PIE.currentStyleMock;
                return el.style[this.styleProperty] || cs.getAttribute(this.cssProperty);
            }),
                    ...
                    if (!destroyed) {
                        if (initialized) {
                            ...
                            if (force || boundsInfo.sizeChanged()) {
                                for (i = 0; i < len; i++) {
                                    if ($(renderers[i].targetElement).is(':visible') === true) {
