<%@ Control Language="C#" AutoEventWireup="true" CodeFile="IntellectMoneyMainProtocol.ascx.cs" Inherits="Admin.UserControls.PaymentMethods.IntellectMoneyMainProtocolControl" %>
