<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RbkMoney.ascx.cs" Inherits="Admin.UserControls.PaymentMethods.RbkMoneyControl" %>
<table border="0" cellpadding="2" cellspacing="0" style="width: 99%; margin-left: 5px;
    ...
    <tr>
         ...
         <td class="columnVal">
            <asp:DropDownList runat="server" ID="ddlCurrency" DataTextField="Value" DataValueField="Key" Width="254" />
        </td>
          <td class="columnDescr">
...
<div class="dvSubHelp2">
    ...
    <a href="http://www.advantshop.net/help/pages/paymentrbkmoney" target="_blank">Инструкция. Подключение платежного модуля RBK Money</a>
</div>