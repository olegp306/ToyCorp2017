<%@ WebHandler Language="C#" Class="Admin.HttpHandlers.AdminMessage.GetListLastAdminMessages" %>
...
{
    public class GetListLastAdminMessages : AdminHandler, IHttpHandler
    {
        public new void ProcessRequest(HttpContext context)
        {
            ...
            if (adminMessage.Items != null && adminMessage.Items.Count > 0)
            {
                ...
                foreach (var message in adminMessage.Items.Where(item => !item.Viewed))
                {
                    messages.Add(new
                        {
