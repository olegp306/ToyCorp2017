<%@ WebHandler Language="C#" Class="Admin.HttpHandlers.Order.CdekReportOrderInfo" %>
...
{
    public class CdekReportOrderInfo : AdminHandler, IHttpHandler
    {
        public new void ProcessRequest(HttpContext context)
        {
            ...
            CdekStatusAnswer result = (new Cdek(shippingMethod.Params)).ReportOrdersInfo(order);
