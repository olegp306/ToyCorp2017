<%@ WebHandler Language="C#" Class="Admin.HttpHandlers.Order.CdekDeleteOrder" %>
...
{
    public class CdekDeleteOrder : AdminHandler, IHttpHandler
    {
        public new void ProcessRequest(HttpContext context)
        {
           ...
           CdekStatusAnswer result = (new Cdek(shippingMethod.Params)).DeleteOrder(order);
