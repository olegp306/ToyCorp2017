<%@ WebHandler Language="C#" Class="Admin.HttpHandlers.Order.CdekCallCustomer" %>
...
{
    public class CdekCallCustomer : AdminHandler, IHttpHandler
    {
        public new void ProcessRequest(HttpContext context)
        {
            ...
            CdekStatusAnswer result = (new Cdek(shippingMethod.Params)).CallCustomer(order);
