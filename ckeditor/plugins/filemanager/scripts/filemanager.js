...
var config = (function () {
    ...
    $.ajax({
        'async': false,
        'url': './scripts/filemanager.config.js?ver=2',
        'dataType': "json",
        cache: false, 
...
if($.urlParam('langCode') != 0 && file_exists ('scripts/languages/'  + $.urlParam('langCode') + '.js?ver=2')) config.options.culture = $.urlParam('langCode');

var lg = [];
$.ajax({
  url: 'scripts/languages/' + config.options.culture + '.js?ver=2',
  async: false,
  dataType: 'json',
...
var cleanString = function(str) {
	...
	var p_replace = 	new Array("S", "s", "Dj", "dj", "Z", "z", "C", "c", "C", "c", "A", 
						...
						"y", "b", "y", "R", "r", "_", "_", "",
	                    "a", "b", "v", "g", "d", "e", "e", "zh", "z", "i", "I", "k", "l", "m", "n", "o", "p", "r", "s", "t", "u", "f", "h", "c", "ch", "sh", "sch", "'", "y", "'", "e", "yu", "ya", 
	                    "A", "B", "V", "G", "D", "E", "E", "ZH", "Z", "I", "I", "K", "L", "M", "N", "O", "P", "R", "S", "T", "U", "F", "H", "C", "CH", "SH", "SCH", "'", "y", "'", "E", "YU", "YA"
					);
...
$(function(){
	...
	$('#uploader').ajaxForm({
		...
		error: function (jqXHR, textStatus, errorThrown) {
			$('#upload').removeAttr('disabled').find("span").removeClass('loading').text(lg.upload);
			$.prompt("Error uploading file" + jqXHR.responseText);
		},
		success: function (result) {
