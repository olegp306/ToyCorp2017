<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="FileManager.Default" %>
...
<body>
    <div>
        ...
        <script type="text/javascript" src="scripts/filemanager.js?ver=2"></script>
    </div>
